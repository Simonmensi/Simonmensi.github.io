...
export function Navigation({ links = NAV_LINKS }: Props) {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-blue-900/10 bg-white/80 backdrop-blur-md dark:bg-gray-950/80 dark:border-white/10">
      <nav
      ...
      >
        ...
        <Link
          href="/"
          onClick={closeMenu}
          className="text-lg font-bold tracking-tight text-blue-900 dark:text-blue-300 transition-colors hover:text-blue-800 dark:hover:text-blue-200"
        >
          {OWNER_NAME}
        </Link>
        ...
        <div className="flex items-center gap-2 md:hidden">
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-md p-2 text-blue-900 dark:text-blue-300 transition-colors hover:bg-blue-50 dark:hover:bg-blue-950"
      ...
      {menuOpen && (
        <div
          id="mobile-menu"
          className="border-t border-blue-900/10 dark:border-white/10 bg-white/95 dark:bg-gray-950/95 backdrop-blur-md md:hidden"
        >
